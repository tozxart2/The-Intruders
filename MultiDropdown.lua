...
function Hide()
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping Left CTRL", Duration = 7})
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateDropdown(DropdownSettings)
            ...
            Dropdown.List.Search.Search.Changed:Connect(function()
